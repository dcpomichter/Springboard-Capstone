...
function GamesPage() {
    ...
    const getGames = async ()=>{
        setLoading(true);
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/games');
        setData(response.data.games);
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Games Retrieved");
        setLoading(false);
    };
...
_s(GamesPage, "ySaE0AHHIn0JC+VUi5cHG7Tx8WM=", false, function() {
    return [
